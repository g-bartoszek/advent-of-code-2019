...
fn main() {
    ...
    let check_pos = |x,y| {
        ...
        let mut interpreter = Interpreter::new(Vec::from(input.clone()), input_rx, output_tx);
    ...
    loop {
        ...
        if v == 0 && last == 1 {
            ...
            if (x-1) >= 99 && check_pos(x-100, y+99) == 1 {
                println!("SUCCESS: {} {} {}", x-100 ,y, (x-100) * 10000 + y);
                return;
            }
